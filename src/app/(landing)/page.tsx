        ...
        <MaxWidthWrapper className='text-center'>
          <div className='relative mx-auto text-center flex flex-col items-center gap-10'>
            ...
            <p className='text-base/7 text-gray-600 max-w-prose text-center text-pretty'>
              Panda is the easiest way to monitor your SaaS. Get instant
              notifications for{' '}
            ...
            <ul className='space-y-2 text-base/7 text-gray-600 text-left flex flex-col items-start'>
              {[
                ...
                <li key={index} className='flex gap-1.5 itemx-center text-left'>
            ...
            <div className='w-full max-w-80'>
              <ShinyButton
                href='/sign-up'
                className='relative z-10 h-14 w-full text-base shadow-log transition-shadow duration-300 hover:shadow-xl'
              >
